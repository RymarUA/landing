      ...
      <main className="min-h-screen bg-[#F6F4EF]">
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-heading text-[#0F2D2A] text-center mb-10">
              ���� ��������
            </h2>
            <div className="grid sm:grid-cols-2 gap-6">
              {values.map((v) => (
                <div
                  key={v.title}
                  className="flex gap-4 p-6 bg-[#F6F4EF] rounded-2xl border border-[#E7EFEA]"
                >
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              {siteConfig.phone && (
                <a
                  ...
                  className="flex items-center gap-3 p-5 bg-[#F6F4EF] rounded-2xl border border-[#E7EFEA]"
                >
