      ...
      <div className="max-w-lg w-full">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <div className="p-8 md:p-10 text-center">
            ...
            <div className="inline-block bg-rose-50 border border-rose-100 rounded-2xl px-6 py-2 mb-6">
              <span className="text-2xl font-black text-rose-500 tracking-widest">#{orderId}</span>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white font-bold py-3.5 rounded-2xl transition-all duration-200 shadow-lg shadow-rose-200 hover:shadow-rose-300 hover:-translate-y-0.5"
              >
                <Instagram size={18} />
