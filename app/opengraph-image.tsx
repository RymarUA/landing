...
const headline = "Ритуали східної медицини";
const subHeadline = "для балансу тіла й духу";
const description =
  "Лікувальні чаї, зігріваючі пластирі, ароматерапія та ортези. Персональні рекомендації від експертів східної практики.";
const badges = ["14+ років досвіду", "Доставка 1–3 дні", "Супровід 24/7"] as const;
const featuredItems = [
  { name: "Матча-еліксир", price: "420 ₴", badge: "ХІТ" },
  { name: "Пластир «Нефрит»", price: "310 ₴", badge: "-15%" },
  { name: "Олія «Тепло Сходу»", price: "390 ₴", badge: "TOP" },
] as const;
...
function createFallbackImage() {
  return new ImageResponse(
    (
      ...
      >
        <span style={{ fontSize: 64, fontWeight: 800 }}>{config.name}</span>
        <span style={{ fontSize: 28, opacity: 0.8 }}>{config.tagline}</span>
      </div>
    ),
    { ...size },
  );
      ...
      (
        ...
        >
          ...
          >
            ...
            >
              <span>{headline}</span>
              <span style={{ color: "#1F6B5E" }}>{subHeadline}</span>
            </div>
