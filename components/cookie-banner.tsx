        ...
        <div className="bg-gray-950 border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-5">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-rose-500/20 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-gray-400 text-xs leading-relaxed">
                  ...
                  <a href="#" className="text-rose-400 hover:text-rose-300 underline">
                    Детальніше
                  </a>
                </p>
              </div>
            ...
            {showDetails && (
              <div className="mt-4 space-y-3 border-t border-white/10 pt-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-10 h-5 bg-rose-500 rounded-full flex items-center justify-end px-0.5 opacity-60 cursor-not-allowed">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`w-10 h-5 rounded-full flex items-center px-0.5 transition-all ${analytics ? "bg-rose-500 justify-end" : "bg-gray-700 justify-start"}`}
                  >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`w-10 h-5 rounded-full flex items-center px-0.5 transition-all ${marketing ? "bg-rose-500 justify-end" : "bg-gray-700 justify-start"}`}
                  >
                    <div className="w-4 h-4 bg-white rounded-full shadow" />
                  </button>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 mt-4">
              <button
                onClick={() => accept(true)}
                className="flex-1 flex items-center justify-center gap-2 bg-rose-500 hover:bg-rose-600 text-white text-xs font-bold py-2.5 rounded-xl transition-colors"
              >
                <Check size={14} />
                Прийняти всі
              </button>
