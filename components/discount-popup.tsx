  ...
  return (
    ...
    <div className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
        ...
        {/* Top gradient bar */}
        <div className="h-1.5 bg-gradient-to-r from-rose-500 via-pink-500 to-amber-400" />
        ...
        {state === "success" ? (
          ...
          <div className="p-8 text-center">
            ...
            <button
              onClick={dismiss}
              className="w-full bg-rose-500 hover:bg-rose-600 text-white font-bold py-3 rounded-2xl transition-colors"
            >
              Перейти до каталогу
            </button>
          </div>
          ...
          <div className="p-7">
            ...
            <h3 className="text-xl font-black text-gray-900 mb-1.5 leading-tight">
              Отримай <span className="text-rose-500">–10%</span><br />
              на перше замовлення!
            </h3>
            <p className="text-gray-500 text-sm mb-5 leading-relaxed">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-rose-400 transition disabled:opacity-60"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={state === "loading"}
                className="flex items-center justify-center gap-2 w-full bg-rose-500 hover:bg-rose-600 disabled:opacity-60 text-white font-black py-3.5 rounded-2xl transition-colors shadow-lg shadow-rose-200"
              >
                {state === "loading" ? (
